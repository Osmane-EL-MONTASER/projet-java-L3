...
public class Graph<T> {
	 ...
	 * 
	 * @return La liste d'adjacences du graphe.
	 */
	...
	/**
	 * Ajouter une relation avec les 2 sommets passés en 
	 * paramètres.
	 * 
	 * @param v1 Le premier sommet.
	 * @param v2 Le deuxième sommet.
	 * @throws EdgeDuplicateException si l'arête existe déjà.
	 */
	public void addEdge(Vertex<T> v1, Vertex<T> v2) throws EdgeDuplicateException {
	...
	/**
	 * Supprimer une relation entre 2 sommets passés en 
	 * paramètres.
	 * 
	 * @param v1 Le premier sommet.
	 * @param v2 Le deuxième sommet.
	 * @throws EdgeNotFoundException Si l'arête n'existe pas.
	 * @throws IllegalArgumentException Si un des sommets n'existe pas.
	 */
